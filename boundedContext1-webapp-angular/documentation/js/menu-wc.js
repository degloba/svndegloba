                ...
                <li class="chapter">
                    ...
                    <li class="chapter modules">
                        ...
                        <ul class="links collapse" ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            ...
                            <li class="link">
                                <a href="modules/ModulModule.html" data-type="entity-link">ModulModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-ModulModule-33652929491fe034b58b78ac9ee795cf"' : 'data-target="#xs-components-links-module-ModulModule-33652929491fe034b58b78ac9ee795cf"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-ModulModule-33652929491fe034b58b78ac9ee795cf"' :
                                            'id="xs-components-links-module-ModulModule-33652929491fe034b58b78ac9ee795cf"' }>
                                            <li class="link">
                                                <a href="components/MiComponenteComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">MiComponenteComponent</a>
                                            </li>
                                        </ul>
                                    </li>
                            </li>
