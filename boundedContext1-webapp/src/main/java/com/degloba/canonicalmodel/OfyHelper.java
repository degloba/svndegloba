 ...
 * En el cas d'una aplicació web el lloc adient per inicialitzar {@link ObjectifyService} i registrar entitats 
 * es en un {@link ServletContextListener}</br>
 * 
 * Si necessitem una lògica de connexió personalitzada (o volem habilitar el servei de memcache), 
