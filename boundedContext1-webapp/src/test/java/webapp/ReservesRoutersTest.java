...
import com.degloba.viatges.webapp.reactive.filters.ConfigurationRouterFunctionReserves;
 ...
 *
 */
public class ReservesRoutersTest {
	
	ConfigurationRouterFunctionReserves config = new ConfigurationRouterFunctionReserves();
