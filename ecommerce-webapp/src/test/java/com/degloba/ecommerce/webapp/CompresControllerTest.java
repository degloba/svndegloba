...
public class CompresControllerTest {
    ...
    static class WebConfig extends WebMvcConfigurationSupport {
        ...
        @Controller
        private static class CompresController {
     
            @RequestMapping(value = "/compres/{id}", method = RequestMethod.GET)
            @ResponseBody
            ...
            @RequestMapping("/compres")
            public String llistaCompres() {
            	 return "Hola world";
            }
