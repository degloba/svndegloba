...
*/
			...
			)
	{
	    ...
	    while (caracteristiquesIter.hasNext())
	    {
	    	...
	    	UIColumn columna = buildColumn(
	    			...
	    			"#{item.caractInmobles[" + caracteristica.getId() + "]}",
	    			"#{inmobleForm.columnesVisibles[" + caracteristica.getId() + "]}",
	    			caracteristica.getNom(), 
	    			caracteristica.getTtpbasic().getKtpbasic(), 
	    			caracteristica.getTtpcontrol().getKtpcontrol(),
			...
			)
	{
	    ...
	    while (caracteristiquesIter.hasNext())
	    {
	    	...
	    	System.out.println("ID/Caract : " + caracteristica.getId() + "/" + caracteristica.getNom() + "\n");
	    	System.out.println("Tipus BD : " + caracteristica.getTtpbasic().getKtpbasic());
	    	System.out.println("Tipus Control : " + caracteristica.getTtpcontrol().getKtpcontrol());
