...
import com.degloba.persistence.test.domain.jpa.BidirectionalChildStringPkListJPA;
import com.degloba.persistence.test.domain.jpa.BidirectionalChildUnencodedStringPkListJPA;
...
import com.degloba.persistence.test.domain.jpa.HasOneToManyChildAtMultipleLevelsJPA;
...
import com.degloba.persistence.test.domain.jpa.HasOneToManyStringPkListJPA;
import com.degloba.persistence.test.domain.jpa.HasOneToManyUnencodedStringPkListJPA;
import com.degloba.persistence.test.domain.jpa.HasOneToManyWithOrderByJPA;
