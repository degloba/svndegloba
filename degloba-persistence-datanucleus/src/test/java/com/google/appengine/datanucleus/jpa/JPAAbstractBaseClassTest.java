...
import com.degloba.persistence.test.domain.jpa.AbstractBaseClassesJPA.Concrete1;
import com.degloba.persistence.test.domain.jpa.AbstractBaseClassesJPA.Concrete2;
import com.degloba.persistence.test.domain.jpa.AbstractBaseClassesJPA.Concrete3;
import com.degloba.persistence.test.domain.jpa.AbstractBaseClassesJPA.Concrete4;
...
public class JPAAbstractBaseClassTest extends JPATestCase {
  ...
  public void testConcrete() throws EntityNotFoundException {
    ...
    Entity concreteEntity = ds.get(concrete.getId());
    ...
    concreteEntity = ds.get(concrete.getId());
