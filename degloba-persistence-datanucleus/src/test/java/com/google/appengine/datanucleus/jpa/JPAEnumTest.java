...
import com.degloba.persistence.test.domain.jpa.HasEnumJPA.MyEnum;

import static com.degloba.persistence.test.domain.jpa.HasEnumJPA.MyEnum.V1;
import static com.degloba.persistence.test.domain.jpa.HasEnumJPA.MyEnum.V2;
