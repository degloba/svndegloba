...
import com.degloba.persistence.test.domain.jpa.IsEmbeddedWithEmbeddedSuperclass;
import com.degloba.persistence.test.domain.jpa.IsEmbeddedWithEmbeddedSuperclass2;
import com.degloba.persistence.test.domain.jpa.SubclassesJPA;
import com.degloba.persistence.test.domain.jpa.SubclassesJPA.Child;
import com.degloba.persistence.test.domain.jpa.SubclassesJPA.ChildEmbeddedInTablePerClass;
import com.degloba.persistence.test.domain.jpa.SubclassesJPA.DurableChild;
import com.degloba.persistence.test.domain.jpa.SubclassesJPA.Grandchild;
import com.degloba.persistence.test.domain.jpa.SubclassesJPA.Joined;
import com.degloba.persistence.test.domain.jpa.SubclassesJPA.JoinedChild;
import com.degloba.persistence.test.domain.jpa.SubclassesJPA.MappedSuperclassChild;
import com.degloba.persistence.test.domain.jpa.SubclassesJPA.MappedSuperclassParent;
import com.degloba.persistence.test.domain.jpa.SubclassesJPA.Parent;
import com.degloba.persistence.test.domain.jpa.SubclassesJPA.SingleTable;
import com.degloba.persistence.test.domain.jpa.SubclassesJPA.SingleTableChild;
import com.degloba.persistence.test.domain.jpa.SubclassesJPA.TablePerClass;
import com.degloba.persistence.test.domain.jpa.SubclassesJPA.TablePerClassChild;
import com.degloba.persistence.test.domain.jpa.SubclassesJPA.TablePerClassGrandchild;
import com.degloba.persistence.test.domain.jpa.SubclassesJPA.TablePerClassParentWithEmbedded;
