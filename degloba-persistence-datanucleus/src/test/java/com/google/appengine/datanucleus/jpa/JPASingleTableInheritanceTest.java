...
import com.degloba.persistence.test.domain.jpa.SingleTableInheritanceJPA.Child11;
import com.degloba.persistence.test.domain.jpa.SingleTableInheritanceJPA.Child11Many;
import com.degloba.persistence.test.domain.jpa.SingleTableInheritanceJPA.Child12;
import com.degloba.persistence.test.domain.jpa.SingleTableInheritanceJPA.Child21;
import com.degloba.persistence.test.domain.jpa.SingleTableInheritanceJPA.Child22;
import com.degloba.persistence.test.domain.jpa.SingleTableInheritanceJPA.ChildBoolIntDiscriminator;
import com.degloba.persistence.test.domain.jpa.SingleTableInheritanceJPA.ChildDateIntDiscriminator;
import com.degloba.persistence.test.domain.jpa.SingleTableInheritanceJPA.ChildToParentWithoutDiscriminator;
import com.degloba.persistence.test.domain.jpa.SingleTableInheritanceJPA.Embedded1;
import com.degloba.persistence.test.domain.jpa.SingleTableInheritanceJPA.Embedded2;
import com.degloba.persistence.test.domain.jpa.SingleTableInheritanceJPA.Parent;
import com.degloba.persistence.test.domain.jpa.SingleTableInheritanceJPA.ParentIntDiscriminator;
