...
import com.degloba.persistence.test.domain.jpa.HasOneToOneChildAtMultipleLevelsJPA;
import com.degloba.persistence.test.domain.jpa.HasOneToOneJPA;
import com.degloba.persistence.test.domain.jpa.HasOneToOneLongPkJPA;
import com.degloba.persistence.test.domain.jpa.HasOneToOneLongPkParentJPA;
import com.degloba.persistence.test.domain.jpa.HasOneToOneLongPkParentKeyPkJPA;
import com.degloba.persistence.test.domain.jpa.HasOneToOneParentJPA;
import com.degloba.persistence.test.domain.jpa.HasOneToOneParentKeyPkJPA;
import com.degloba.persistence.test.domain.jpa.HasOneToOneStringPkJPA;
import com.degloba.persistence.test.domain.jpa.HasOneToOneStringPkParentJPA;
import com.degloba.persistence.test.domain.jpa.HasOneToOneStringPkParentKeyPkJPA;
