...
import static com.degloba.persistence.test.domain.jpa.OwnedJoinsJPA.Course;
import static com.degloba.persistence.test.domain.jpa.OwnedJoinsJPA.Major;
import static com.degloba.persistence.test.domain.jpa.OwnedJoinsJPA.newCourse;
import static com.degloba.persistence.test.domain.jpa.OwnedJoinsJPA.newMajor;
import static com.degloba.persistence.test.domain.jpa.OwnedJoinsJPA.newStudent;

import com.google.appengine.datanucleus.jpa.JPATestCase;
import com.degloba.persistence.test.domain.jpa.OwnedJoinsJPA.Student;
