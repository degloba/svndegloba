...
import com.degloba.persistence.test.domain.jpa.BidirectionalChildJPA;
import com.degloba.persistence.test.domain.jpa.BidirectionalChildLongPkJPA;
import com.degloba.persistence.test.domain.jpa.BidirectionalChildUnencodedStringPkJPA;
import com.degloba.persistence.test.domain.jpa.Book;
import com.degloba.persistence.test.domain.jpa.HasKeyPkJPA;
import com.degloba.persistence.test.domain.jpa.HasOneToManyJPA;
import com.degloba.persistence.test.domain.jpa.HasOneToManyKeyPkJPA;
import com.degloba.persistence.test.domain.jpa.HasOneToManyLongPkJPA;
import com.degloba.persistence.test.domain.jpa.HasOneToManyUnencodedStringPkJPA;
