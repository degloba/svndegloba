...
import com.degloba.persistence.test.domain.jpa.BaseVersionSubclass;
import com.degloba.persistence.test.domain.jpa.HasIntVersionJPA;
import com.degloba.persistence.test.domain.jpa.HasIntegerVersionJPA;
import com.degloba.persistence.test.domain.jpa.HasLongVersionJPA;
import com.degloba.persistence.test.domain.jpa.HasPrimitiveLongVersionJPA;
import com.degloba.persistence.test.domain.jpa.HasPrimitiveShortVersionJPA;
import com.degloba.persistence.test.domain.jpa.HasShortVersionJPA;
import com.degloba.persistence.test.domain.jpa.HasTimestampVersionJPA;
import com.degloba.persistence.test.domain.jpa.HasVersionJPA;
import com.degloba.persistence.test.domain.jpa.HasVersionMain;
import com.degloba.persistence.test.domain.jpa.HasVersionSub;
