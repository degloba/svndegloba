...
import com.degloba.persistence.test.domain.jpa.HasChildWithSeparateNameFieldJPA;
import com.degloba.persistence.test.domain.jpa.HasEncodedStringPkSeparateNameFieldJPA;
import com.degloba.persistence.test.domain.jpa.HasKeyPkJPA;
import com.degloba.persistence.test.domain.jpa.HasLongPkOneToManyBidirChildrenJPA;
import com.degloba.persistence.test.domain.jpa.HasPolymorphicRelationsListJPA;
import com.degloba.persistence.test.domain.jpa.HasUnencodedStringPkOneToManyBidirChildrenJPA;
import com.degloba.persistence.test.domain.jpa.BidirectionalSingleTableChildListJPA.BidirBottomList;
import com.degloba.persistence.test.domain.jpa.BidirectionalSingleTableChildListJPA.BidirBottomLongPkList;
import com.degloba.persistence.test.domain.jpa.BidirectionalSingleTableChildListJPA.BidirBottomStringPkList;
import com.degloba.persistence.test.domain.jpa.BidirectionalSingleTableChildListJPA.BidirBottomUnencodedStringPkList;
import com.degloba.persistence.test.domain.jpa.BidirectionalSingleTableChildListJPA.BidirMiddleList;
import com.degloba.persistence.test.domain.jpa.BidirectionalSingleTableChildListJPA.BidirMiddleLongPkList;
import com.degloba.persistence.test.domain.jpa.BidirectionalSingleTableChildListJPA.BidirMiddleStringPkList;
import com.degloba.persistence.test.domain.jpa.BidirectionalSingleTableChildListJPA.BidirMiddleUnencodedStringPkList;
import com.degloba.persistence.test.domain.jpa.BidirectionalSingleTableChildListJPA.BidirTopList;
import com.degloba.persistence.test.domain.jpa.BidirectionalSingleTableChildListJPA.BidirTopLongPkList;
import com.degloba.persistence.test.domain.jpa.BidirectionalSingleTableChildListJPA.BidirTopStringPkList;
import com.degloba.persistence.test.domain.jpa.BidirectionalSingleTableChildListJPA.BidirTopUnencodedStringPkList;
import com.degloba.persistence.test.domain.jpa.HasPolymorphicRelationsListJPA.HasOneToManyKeyPkListJPA;
import com.degloba.persistence.test.domain.jpa.HasPolymorphicRelationsListJPA.HasOneToManyListJPA;
import com.degloba.persistence.test.domain.jpa.HasPolymorphicRelationsListJPA.HasOneToManyLongPkListJPA;
import com.degloba.persistence.test.domain.jpa.HasPolymorphicRelationsListJPA.HasOneToManyStringPkListJPA;
import com.degloba.persistence.test.domain.jpa.HasPolymorphicRelationsListJPA.HasOneToManyUnencodedStringPkListJPA;
import com.degloba.persistence.test.domain.jpa.HasPolymorphicRelationsListJPA.HasOneToManyWithUnsupportedInheritanceList;
import com.degloba.persistence.test.domain.jpa.SubclassesJPA.MappedSuperclassChild;
import com.degloba.persistence.test.domain.jpa.SubclassesJPA.TablePerClassChild;
import com.degloba.persistence.test.domain.jpa.UnidirectionalSingeTableChildJPA.UnidirBottom;
import com.degloba.persistence.test.domain.jpa.UnidirectionalSingeTableChildJPA.UnidirMiddle;
import com.degloba.persistence.test.domain.jpa.UnidirectionalSingeTableChildJPA.UnidirTop;

import java.util.Collections;

import static com.degloba.persistence.PolymorphicTestUtils.assertKeyParentEquals;
