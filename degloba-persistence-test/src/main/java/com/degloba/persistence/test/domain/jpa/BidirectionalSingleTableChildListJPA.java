...
import com.degloba.persistence.test.domain.jpa.BidirectionalSingleTableChildJPA.BidirBottom;
import com.degloba.persistence.test.domain.jpa.BidirectionalSingleTableChildJPA.BidirBottomLongPk;
import com.degloba.persistence.test.domain.jpa.BidirectionalSingleTableChildJPA.BidirBottomUnencodedStringPk;
import com.degloba.persistence.test.domain.jpa.BidirectionalSingleTableChildJPA.BidirMiddle;
import com.degloba.persistence.test.domain.jpa.BidirectionalSingleTableChildJPA.BidirMiddleLongPk;
import com.degloba.persistence.test.domain.jpa.BidirectionalSingleTableChildJPA.BidirMiddleUnencodedStringPk;
...
import com.degloba.persistence.test.domain.jpa.HasPolymorphicRelationsJPA.HasOneToManyJPA;
import com.degloba.persistence.test.domain.jpa.HasPolymorphicRelationsJPA.HasOneToManyLongPkJPA;
import com.degloba.persistence.test.domain.jpa.HasPolymorphicRelationsJPA.HasOneToManyUnencodedStringPkJPA;
