package com.degloba.persistencia.Google;
...
* 
*/
public class UtilPersistenciaGAE {

private static final Logger logger = Logger.getLogger(UtilPersistenciaGAE.class.getCanonicalName());
