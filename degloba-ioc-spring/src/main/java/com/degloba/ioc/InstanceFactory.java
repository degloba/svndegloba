...
 * Implementation of the plant. In the background, through InstanceProvider policy interface, 
 * ens permet seleccionar diferents Fabriques IoC, com ara Spring, Google Guice, TapestryIoC etc.
 * <p>
