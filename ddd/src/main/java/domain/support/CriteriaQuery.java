...
/**
 * Conditions queries. One of the four inquiries form DDDLib support . Specify the query criteria , 
 * sorting properties and for taking a subset of the results for a specific entity , such as via DSL . Created with
