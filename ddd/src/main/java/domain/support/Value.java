...
/**
 * Value. The value of this class is primarily used to customize the attributes of the entity class , 
 * for example, the Employee class to dynamically add a number of attributes, each type of data is recorded and a string
 *
 * @author chencao
 *
 */
