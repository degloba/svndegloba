 ...
 */
package com.degloba.travel.integration.spring.amqp;
...
public final class SamplePubConfirmsReturns {
	...
	public static void main(final String... args) {
		...
		final AbstractApplicationContext context =
				new ClassPathXmlApplicationContext("classpath:META-INF/spring/spring-integration-confirms-context.xml");
