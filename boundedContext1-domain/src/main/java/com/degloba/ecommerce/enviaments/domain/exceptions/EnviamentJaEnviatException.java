...
public class EnviamentJaEnviatException {
	...
	private EnviamentJaEnviatException(Enviament enviament, Usuari userId) {
        //super("bike '" + enviament.getComandaId() + "' is already booked by user '" + usuari. + "'");
    }

  //  static EnviamentJaEnviatException bikeAlreadyBooked(Enviament enviament, Usuari userId) {
        //return new EnviamentJaEnviatException(numberPlate, userId);
    //}
}
