...
import com.degloba.persistence.datanucleus.jpa.HasOneToOneChildAtMultipleLevelsJPA;
import com.degloba.persistence.datanucleus.jpa.HasOneToOneJPA;
import com.degloba.persistence.datanucleus.jpa.HasOneToOneLongPkJPA;
import com.degloba.persistence.datanucleus.jpa.HasOneToOneLongPkParentJPA;
import com.degloba.persistence.datanucleus.jpa.HasOneToOneLongPkParentKeyPkJPA;
import com.degloba.persistence.datanucleus.jpa.HasOneToOneParentJPA;
import com.degloba.persistence.datanucleus.jpa.HasOneToOneParentKeyPkJPA;
import com.degloba.persistence.datanucleus.jpa.HasOneToOneStringPkJPA;
import com.degloba.persistence.datanucleus.jpa.HasOneToOneStringPkParentJPA;
import com.degloba.persistence.datanucleus.jpa.HasOneToOneStringPkParentKeyPkJPA;
...
import static com.degloba.persistence.datanucleus.TestUtils.assertKeyParentNull;
...
public class JPAOneToOneTest extends JPATestCase {
  ...
  private void testQuery(StartEnd startEnd) {
    ...
    javax.persistence.Query q = em.createQuery(
        "select from " + HasOneToOneJPA.class.getName() + " b where id = :key");
