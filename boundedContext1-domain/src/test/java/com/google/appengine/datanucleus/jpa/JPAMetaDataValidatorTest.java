...
import com.degloba.persistence.datanucleus.jpa.IgnorableMappingsJPA.HasInitialSequenceValue;
import com.degloba.persistence.datanucleus.jpa.IgnorableMappingsJPA.HasUniqueConstraint;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.EncodedPkOnNonPrimaryKeyField;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.EncodedPkOnNonStringPrimaryKeyField;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.HasLongPkWithStringAncestor;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.HasMultiplePkIdFields;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.HasMultiplePkNameFields;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.HasPkIdSortOnOneToMany;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.HasPkNameSortOnOneToMany;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.HasUnencodedStringPkWithStringAncestor;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.LongParent;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.ManyToMany1;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.ManyToMany2;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.MultipleAncestors;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.OneToManyParentWithRootOnlyLongBiChild;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.OneToManyParentWithRootOnlyLongUniChild;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.OneToManyParentWithRootOnlyStringBiChild;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.OneToManyParentWithRootOnlyStringUniChild;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.OneToOneParentWithRootOnlyLongBiChild;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.OneToOneParentWithRootOnlyLongUniChild;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.OneToOneParentWithRootOnlyStringBiChild;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.OneToOneParentWithRootOnlyStringUniChild;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.PkIdOnNonLongField;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.PkIdWithUnencodedStringPrimaryKey;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.PkMarkedAsAncestor;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.PkMarkedAsPkId;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.PkMarkedAsPkName;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.PkNameOnNonStringField;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.PkNameWithUnencodedStringPrimaryKey;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.SequenceOnEncodedStringPk;
import com.degloba.persistence.datanucleus.jpa.IllegalMappingsJPA.SequenceOnKeyPk;
